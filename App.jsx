...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white page-enter">
      ...
      {/* ── FLOATING BOT BUTTON ── */}
      <a
        href="https://t.me/upnex_uzbot"
        target="_blank"
        rel="noopener noreferrer"
        className="bot-float btn-shine fixed bottom-6 right-6 z-[200] flex items-center gap-2 rounded-full bg-blue-600 px-5 py-3 text-sm font-semibold text-white transition-all hover:bg-blue-500 hover:scale-105"
      >
